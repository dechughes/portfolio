...
### **Revenue & Volume**
- What is the total revenue across the period?  
...
- Is the marketplace dependent on a small number of sellers?

### **Unit Economics**
- What is the contribution margin per order and per customer?  
- How do one‑time and repeat customers compare on profitability?  
- What does break‑even look like at a platform level?

---

## **What This Project Demonstrates**

- Joining multiple relational tables in a realistic schema  
- Performing aggregations, grouping, and filtering across large transactional datasets  
- Using window functions where appropriate  
- Structuring SQL queries for clarity and reproducibility  
- Translating data outputs into commercial insights  
- Modelling unit economics using realistic cost assumptions